...
st.markdown("Welcome! Paste a sentence or paragraph below and find out if it was **AI-generated** or **Human-written**. (Take note, this website may not be completely accurate, as it was formulated only by Grade 12 students who may lack experience.)")

# Large input area
user_input = st.text_area("Please put more than 7 words for better accuracy. Input your text here:", height=200, placeholder="Type or paste your text...")
...
#AI written:
    ...
    ("In recent years, artificial intelligence has revolutionized the way we interpret vast amounts of data.", 0),
    ("The implications of deep learning extend far beyond traditional computing paradigms.", 0),
    ("Automated systems are increasingly capable of performing complex tasks with minimal human oversight.", 0),
    ("Through reinforcement learning, agents can learn optimal behaviors by interacting with dynamic environments.", 0),
    ("Machine learning models can now generate human-like language that mimics natural conversations.", 0),
    ("The integration of large language models in business processes enhances productivity and decision-making.", 0),
    ("Generative AI enables the synthesis of novel content based on learned patterns from massive datasets.", 0),
    ("Natural language processing allows machines to understand, interpret, and respond to human communication.", 0),
    ("AI-driven forecasting models are used to optimize inventory and supply chain operations.", 0),
    ("Language models trained on extensive corpora can simulate reasoning and contextual awareness.", 0),
